...
const rendered2 = () => {
    ...
    console.log( syncInputs(inputAmount,rangeAmount,eventType='input'));
    console.log( syncInputs(inputRate,rangeRate,eventType='input'));
    console.log( syncInputs(inputTime,rangeTime,eventType='input'));
