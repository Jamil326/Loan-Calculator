...
btn.addEventListener('click',() =>{
    ...
    syncInputs(inputAmountValue,rangeAmountValue,eventType='input');
    syncInputs(inputRateValue,rangeRateValue,eventType='input');
    syncInputs(inputTimeValue,rangeTimeValue,eventType='input');
