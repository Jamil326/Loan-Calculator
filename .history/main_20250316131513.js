    ...
    getInterest(){
     ...
     getEmiBreakDown(){
          ...
          for( let month =1 ; month <= monthTenure; month++ ) {
              interest =Math.ro balance*monthlyRate;
              ...
              this.transactions.push({ emi:emi,interest:Math.round(interest),principal:Math.round(principal),balance:Math.round(balance)
              ,month:month});
