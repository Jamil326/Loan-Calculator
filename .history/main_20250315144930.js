...
class Calculate{
    ...
    getInterest(){
     ...
     getAllTransaction(){
         return {emi:this.getEmi(),totalInterst:this.getInterest(),totalpaid:this.getTotalPaid(),amount:this.amount}
     }
...
interest.textContent = '₹'+" "+datas.totalInterest;
total.textContent = '₹'+' '+datas.to;
