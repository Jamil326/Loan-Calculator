    ...
    getInterest(){
     ...
     getEmiBreakDown(){
          ...
          for( let month =1 ; month <= monthTenure; month++ ) {
              ...
              this.transactions.push({ emi:emi,interest:interest,principal:principal,balance:balance,month:month});
...
console.log(cal.datass.emi);
console.log(cal.datass.totalInterest);
console.log(cal.totalpaid);
