    ...
    let inputAmount =parseInt(document.getElementById('input-amount').value,10) ;
    let inputRate = parseInt( document.getElementById('input-rate').value,10);
    let inputTime = parseInt( document.getElementById('input-time').value,10);


    let rangeAmount = parseInt( document.getElementById('amount').value,10);
    let rangeRate = parseInt(document.getElementById('rate').value,10);
    let rangeTime = parseInt(document.getElementById('time').value,10);
    ...
    inputInput.addEventListener(eventType, () => {
        ...
        rangeSlider.value = inputInput;
        console.log(parseInt(rangeSlider));
        console.log(typeof value);
        console.log(typeof rangeSlider);
    ...
    rangeSlider.addEventListener(eventType, () => {
        ...
        inputInput = rangeSlider;
        console.log(inputInput);
        console.log(typeof inputInput); 
    });
};
