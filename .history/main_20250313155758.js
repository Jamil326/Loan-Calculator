// elementsVlue
    ...
    // make input function 
       const syncInputs = (inputInput, rangeSlider, eventType = 'input',fn) => {
    ...
    rangeSlider.addEventListener(eventType, () => {
      let  rangleSliderValue = parseInt(rangeSlider.value);
      let inputInputValue = parseInt(rangeSlider.value);
      inputInputValue = rangleSliderValue;
...
doCalculate(10000,20,1);


    syncInputs(inputAmount,rangeAmount,eventType='input',doCalculate);
    syncInputs(inputRate,rangeRate,eventType='input',doCalculate);
    syncInputs(inputTime,rangeTime,eventType='input',doCalculate);
