    ...
    if (!inputInput || !rangeSlider) {
        console.error('Both input and rangeSlider elements are required');
        return;
    }
...
btn.addEventListener('click',() =>{
    ...
    syncInputs(inputAmount,rangeAmount,eventType);
    syncInputs(inputRate,rangeRate,eventType);
    syncInputs(inputTime,rangeTime,eventType);
