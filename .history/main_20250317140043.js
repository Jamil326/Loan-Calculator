...
getEmiBreakDown() {
    ...
    let emi = this.getEmi(); // Keep EMI unrounded
    ...
    console.log("✅ Total Payment:", Math.round(totalPrincipal + totalInterest)); // Should be ₹90,234

    return {
        transactions: this.transactions,
        finalInterest: Math.round(totalInterest),
        totalAmountPaid: Math.round(totalPrincipal + totalInterest)
    };
}
