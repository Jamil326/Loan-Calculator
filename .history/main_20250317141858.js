...
class Calculate{
    ...
    getInterest(){
     ...
     getAllTransaction(){
      ...
      getEmiBreakDown (principal, annualRate, tenureYears) {
    ...
    for (let month; month <= totalMonths; month++) {
        ...
        if (principalPaid > balance) {
            ...
            emi = interest + principalPaid; // Adjust EMI
        }
        ...
        if (balance <= 0) break; // Stop when loan is fully repaid
    }
